...
class TestConta:
    ...
    def test_get_saldo_quando_conta_tem_saldo_entao_retorne_saldo(self):
        # Arrange
    ...
    def test_deposito_quando_conta_com_saldo_entao_adiciona_valor_ao_saldo(self, conta_com_saldo):
        # Arrange
        valor = 100
    ...
    def test_saque_quando_conta_com_saldo_entao_remove_valor_do_saldo(self, conta_com_saldo):
        # Arrange
        valor = 100
    ...
    def test_transferir_quando_conta_com_saldo_entao_debita_na_conta_origem(self, conta_com_saldo):
        # Arrange
    ...
    def test_tranferir_quando_conta_com_saldo_entao_transfere_credita_na_conta_destino(self, conta_com_saldo):
        # Arrange
        usuario_destino = Usuario("Carlos Martins", "carlos.martins@example.com", "senha1234", "03004508902", date(1991, 6, 7))
        conta_destino = Conta(1002, "1234-5", "001", "Banco VVT", usuario_destino, 2000.0, date.today(), True)
    ...
    def test_fechar_conta_quando_conta_esta_com_saldo_entao_raise_exception(self, conta_com_saldo):
    ...
    def test_fechar_conta_quando_conta_esta_com_saldo_negativo_entao_raise_exception(self, conta_com_saldo_negativo):
    ...
    def test_fechar_conta_quando_conta_sem_saldo_entao_usuario_conta_is_none(self, conta_sem_saldo):
        # Act
    ...
    def test_fechar_conta_quando_conta_sem_saldo_entao_conta_ativa_to_false(self, conta_sem_saldo):
       # Act
       conta_sem_saldo.fechar_conta()
    ...
    def test_saldo_negativo_quando_conta_esta_com_saldo_entao_retorne_falso(self, conta_com_saldo):
        # Act
    ...
    def test_saldo_negativo_quando_conta_esta_sem_saldo_entao_retorne_falso(self, conta_sem_saldo):
        # Act
    ...
    def test_saldo_negativo_quando_conta_esta_com_saldo_negativo_entao_retorne_true(self, conta_com_saldo_negativo):
        # Act
    ...
    def test_aplica_juros_quando_conta_esta_com_saldo_entao_aplique_juros_com_sucesso(self, conta_com_saldo):
        # Arrange
        porcentagem = .10
